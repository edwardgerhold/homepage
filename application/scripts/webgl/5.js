...
*/
    ...
    gl.bufferData(gl.ARRAY_BUFFER, new Uint8Array(cubeVertexColors), gl.STATIC_DRAW);
...
function draw() {
    ...
    //mat4.rotate(uVMatrix, uVMatrix, 0.01, [2, 2, 5]);
    mat4.rotate(uMMatrix, uMMatrix, 0.01, [0, 0, 1]);
    mat3.normalFromMat4(uNMatrix, uMMatrix);
