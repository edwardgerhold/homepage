<?php
/**
 * @description Inspector is from Pro PHP MVC by Chris Pitt
 */
namespace Framework;
...
class Inspector {
    ...
    protected function _getMethodComment($property) {
        $reflection = new \ReflectionMethod($this->_class, $property);
        return $reflection->getDocComment();
    }
